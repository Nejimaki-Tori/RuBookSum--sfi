  ...
  \begin{algorithm}[H]
    ...
    \begin{algorithmic}
      ...
      \Repeat
        ...
        \State $S_\ell \gets \{s_i\mid s_i \in S_\ell'$ \textbf{and} $\max_{j<i} M_{ij} < \theta \}$
        \State $S_\ell \gets S_\ell \cup s_0$
        \State $Groups \gets GroupSummaries(S_\ell)$
        \State $\ell \gets \ell + 1$
        \For{$g \in Groups$}
          \State $S_\ell \gets S_\ell \cup \{MergeGroup(p_\theta,g)\}$
...
% \bibitem{BookSum}
% Kryściński, W., Rajani, N., Agarwal, D., Xiong, C., Radev, D.:
% BOOKSUM: A Collection of Datasets for Long-form Narrative Summarization.
% In: Goldberg, Y., Kozareva, Z., Zhang, Y. (eds.) Findings of the Association for Computational Linguistics: EMNLP 2022,
% pp. 6536--6558. Association for Computational Linguistics, Abu Dhabi (2022).
% \url{https://doi.org/10.18653/v1/2022.findings-emnlp.488}
% 
% \bibitem{alexandria}
% Scir\`e, A., Conia, S., Ciciliano, S., Navigli, R.:
% Echoes from Alexandria: A Large Resource for Multilingual Book Summarization.
% In: Rogers, A., Boyd-Graber, J., Okazaki, N. (eds.) Findings of the Association for Computational Linguistics: ACL 2023,
% pp. 853--867. Association for Computational Linguistics, Toronto (2023).
% \url{https://doi.org/10.18653/v1/2023.findings-acl.54}
% 
% \bibitem{fables}
