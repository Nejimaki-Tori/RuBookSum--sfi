...
\begin{document}
\raggedbottom
\author{Denis\,A.~Grigoriev\footnote{\label{msu}Lomonosov Moscow State University, Moscow Center for Fundamental and Applied Mathematics, \\ Moscow, Russian Federation} \and Daniil\,V.~Khudiakov\footnoteref{msu} \and Daniil\,I.~Chernyshev\footnoteref{msu}}
...
These chunks are then grouped (shown as GroupSummaries in Algorithm \ref{alg:h}), and summaries are merged into higher-level summaries (MergeGroup in Algorithm \ref{alg:h}).
