...
\begin{document}
\raggedbottom
\author{Denis\,A.~Grigoriev\footnote{\label{msu}Lomonosov Moscow State University, Moscow Center for Fundamental and Applied Mathematics, \\ Moscow, Russian Federation}\orcidID{0009-0007-2675-001X} \and Daniil\,V.~Khudiakov\footnoteref{msu} \and Daniil\,I.~Chernyshev\footnoteref{msu}\orcidID{0009-0001-6847-2122}}
...
\fig{width=0.8\linewidth}{figures/genres_pie.png}{Distribution of texts by genres (top 10; "Other" aggregates all remaining genres)}
...
In all tables models are grouped by parameter count: within each size group, the best result is underlined, and the overall best is bold. 
Values are mean $\pm$ SD across test documents.
